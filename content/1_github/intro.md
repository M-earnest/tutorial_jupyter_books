...
<img src="https://github.com/DiLER-Digitell/Jupyter-Book/tree/main/static/template_structure.png?raw=true" alt="png depicting the file structure of the course template repository" class="bg-primary" width="500px"> 
...
This project is built on the idea that the knowledge that we're trying to share and that the courses built on this framework should be as accessible as possible; therefore, we opted to host this [course](https://github.com/DiLER-Digitell/Jupyter-Book), as well as our [course template](https://github.com/DiLER-Digitell/Course-template) via GitHub. This allows you and others to simply download the contained materials and adapt them to make your own projects. Further, GitHub allows us to host websites like this one via the "GitHub pages" service free of any charge.
